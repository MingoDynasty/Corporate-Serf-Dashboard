...
**Source of truth.** This is the finalized, canonical proposal for the
relative-timestamp feature; build from this file. The iterative drafts (v1–v6)
that produced it are preserved in git history. Implement in two phases — start
with **Phase 1** (see [Phasing](#phasing)); grid live-ticking is Phase 2.
