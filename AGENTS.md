...
- `docs/` — living docs (architecture, `decision_log.md`, `product.md`,
  `user_guide.md`), current-behavior capability specs (`docs/specs/`), plus
  proposals for in-flight work (`docs/proposals/`). One file per proposal
...
- Use the user guide's [What it talks to](docs/user_guide.md#what-it-talks-to)
  ...
  in the same PR, and checks that the README's What it talks to summary is
  still true. The section lists services and what makes the app reach them,
